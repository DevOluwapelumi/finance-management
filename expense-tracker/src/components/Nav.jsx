...
//   };
  ...
  const handleClickOutside = (event) => {
    if (
      ...
      !event.target.closest(".sidebar-toggle") // Check if clicked outside sidebar and sidebar toggle button
    ) {
    ...
    <>
      ...
      >
        <div className="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
          ...
          <li>
             <Link to="/dashboard"  className="flex items-center p-2 mt- text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
             <FaList />
